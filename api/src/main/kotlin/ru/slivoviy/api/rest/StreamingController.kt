...
class StreamingController(
    ...
    fun uploadVideo(@RequestParam("file") videoFile: MultipartFile): ResponseEntity<Long> {
    ...
    private fun uploadFile(id: Long, videoFile: MultipartFile) {
        ...
        val file = File("/Users/sael/IdeaProjects/i-hate-kafka/api/src/main/resources/targetFile.tmp")

        FileOutputStream(file).use { os -> os.write(videoFile.bytes) }
