package ru.slivoviy.orchestrator.internal.configuration
...
@EnableJpaRepositories(
    basePackages = ["ru.slivoviy.orchestrator.logic.repository"],
...
class DatabaseConfiguration {
    ...
    fun entityManagerFactory(
        ...
        return builder
            ...
            .packages("ru.slivoviy.orchestrator.logic.entity")
